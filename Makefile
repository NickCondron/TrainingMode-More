...
dats = build/ledgedash.dat build/wavedash.dat build/lcancel.dat build/labCSS.dat build/eventMenu.dat build/lab.dat build/powershield.dat build/slalom.dat
...
build/slalom.dat: src/slalom.c src/slalom.h src/events.h
