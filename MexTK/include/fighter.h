...
struct FighterData
{
    ...
    {                              //
        ...
        u16 last_move_hurt;        // 0x240a, Previous Move Instance Hit By
        u16 vuln_frames;           // 0x240c, how many frames the fighter has been vulnerable
        u16 can_fastfall_frames;   // 0x240e, how many frames the fighter has been able to fast fall
        int post_hitstun_frames;   // 0x2410, frames fighter has been out of hitstun
        GOBJ *fighter_hurt_shield; // 0x2414, pointer to the fighter who's shield this fighter hit
        void *cb_anim;             // 0x2418, additional animation callback
        u16 iasa_frames;           // 0x241c Aitch: added this for use in lab overlays. Hope it doesn't break anything.
    } TM;
};
